        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThresholdAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    Category = table.Column<string>(type: "text", nullable: true),
                    ActiveDays = table.Column<DayOfWeek[]>(type: "jsonb", nullable: true),
                    ActiveFromHour = table.Column<int>(type: "integer", nullable: true),
                    ActiveToHour = table.Column<int>(type: "integer", nullable: true),
                    Action = table.Column<string>(type: "text", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    TriggerCount = table.Column<int>(type: "integer", nullable: false),
                    HeededCount = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommitmentDevices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommitmentDevices_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageOverspendPercent = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpendingTriggers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpendingTriggers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmotionalNote = table.Column<string>(type: "text", nullable: true),
                    IsImpulse = table.Column<bool>(type: "boolean", nullable: false),
                    NudgeShown = table.Column<bool>(type: "boolean", nullable: false),
                    NudgeHeeded = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommitmentDevices_UserId",
                table: "CommitmentDevices",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SpendingTriggers_UserId",
                table: "SpendingTriggers",
                column: "UserId");
